package bplustreegithub;

import pkg1.MultiCounter;
...
import bplustreegithub2.InvalidBTreeStateException;
...
public class BPlusTree {
    ...
    public BPlusTree(int pageSize, int keySize, int entrySize) throws IOException, InvalidBTreeStateException {
        this.conf = new BPlusConfiguration(pageSize, keySize, entrySize);
